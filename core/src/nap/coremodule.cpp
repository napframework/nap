...
ModuleNapCore::ModuleNapCore() : nap::Module("NapCore")
{
	...
	NAP_REGISTER_OPERATOR(nap::FloatToStringOperator)
	NAP_REGISTER_OPERATOR(nap::LogOperator)

	NAP_REGISTER_OPERATOR(nap::OSCOperator)
	NAP_REGISTER_OPERATOR(nap::CompareStringOperator)
	NAP_REGISTER_OPERATOR(nap::SwitchOperator)
