...
namespace tinyxml2
{
	...
	*/
	...
	/**
		...
		false, <b>no children of this object or its siblings</b> will be visited.
	...
	*/
	...
	/** XMLNode is a base class for every object that is in the
		XML Document AttributeObject Model (DOM), except XMLAttributes.
		Nodes have siblings, a parent, and children which can
		be navigated. A object is always in a XMLDocument.
	...
	*/
	class TINYXML2_LIB XMLNode
	{
	  ...
	  public:
		...
		*/
		...
		/** Set the Value of an XML object.
			@sa Value()
		*/
		void SetValue(const char* val, bool staticMem = false);

		/// Get the parent of this object on the DOM.
		...
		/// Get the first child object, or null if none exists.
		...
		*/
		...
		/// Get the last child object, or null if none exists.
		...
		*/
		...
		/// Get the previous (left) sibling object of this node.
		const XMLNode* PreviousSibling() const { return _prev; }

		XMLNode* PreviousSibling() { return _prev; }

		/// Get the previous (left) sibling element of this object, with an optionally supplied name.
		...
		/// Get the next (right) sibling node of this object.
		const XMLNode* NextSibling() const { return _next; }

		XMLNode* NextSibling() { return _next; }

		/// Get the next (right) sibling element of this object, with an optionally supplied name.
		...
		/**
			...
			If the child object is already part of the document,
		...
		*/
		...
		/**
			Add a child object as the first (left) child.
		...
		*/
		...
		/**
			Add a node after the specified child object.
			If the child node is already part of the document,
			it is moved from its old location to the new location.
		...
		*/
		...
		/**
			...
			the parent of the new Operator. If the 'document' is
			null, then the object returned will be allocated
		...
		*/
		...
		/** Accept a hierarchical visit of the nodes in the TinyXML-2 DOM. Every object in the
	...
	/** XML text.
		...
		Note that a text object can have child element nodes, for example:
		@verbatim
	...
	*/
	class TINYXML2_LIB XMLElement : public XMLNode
	{
	  ...
	  public:
		/// Get the name of an element (which is the Value() of the object.)
		...
		*/
		...
		/** Convenience function for easy access to the text inside an element. Although easy
			...
			then the value of str would be null. The first child object isn't a text node, it is
		...
		*/
		...
		/**
			Convenience method to query the value of a child text object. This is probably best
	...
	*/
	  ...
	  public:
		...
		*/
		...
		/** Return the root element of DOM. Equivalent to FirstChildElement().
			To get the first object, use FirstChild().
		*/
		...
		*/
		...
		/**
			Delete a object associated with this document.
	...
	/**
		...
		It is also safe to copy handles - internally they are nothing more than object pointers.
		@verbatim
	...
	*/
	...
	{
	  public:
		/// Create a handle from any object (at any depth of the tree.) This can be a null pointer.
		XMLHandle(XMLNode* node) { _node = node; }
		/// Create a handle from a object.
		XMLHandle(XMLNode& node) { _node = &node; }
		/// Copy constructor
	...
	class TINYXML2_LIB XMLPrinter : public XMLVisitor
	{
	  public:
		...
		*/
		...
		/// Add a text object from an integer.
		void PushText(int value);
		/// Add a text object from an unsigned.
		void PushText(unsigned value);
		/// Add a text object from a bool.
		void PushText(bool value);
		/// Add a text object from a float.
		void PushText(float value);
		/// Add a text object from a double.
