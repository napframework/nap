...
After creation your new project is located at `projects/newproject`. This directory contains the application source-code, scenes, assets and build instructions. The `project.json` file (located in the root of the project) controls how your application is called and what modules it requires:
