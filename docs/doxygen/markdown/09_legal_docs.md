...
### 1.1 In these Terms of Use, the following terms shall have the meanings set out below unless the context requires otherwise: ###
	...
	- License: the right to use the Software and/or the Services pursuant to the Terms of Use;

	- Services: means all services made available by Naivi on the Website or otherwise, including the Software, but not limited to the New Amsterdam Platform a platform that allows you to make your own applications.

	- Software:	all software, software platforms and packages made available by or on behalf of Naivi on the Website or otherwise, including updates and upgrades as well as accompanying manual(s), and other written, files, online materials or documentation, and any and all copies of such software and its materials;
