<br>
<p align="center">
  <img width=384 src="https://docs.nap.tech/content/nap_logo_blue_medium.png">
</p>
...
[NAP framework](https://nap.tech) is an open source, low overhead, real-time control & visualization plaform. Create fast, modular and (above all) stable applications to interact with the world around you.
...
NAP documentation can be found online at [docs.nap.tech](https://docs.nap.tech). Take note that the installation and project creation instructions on that website apply to the binary (compiled) NAP package only. Follow the instructions in this document to build and work against NAP Framework from source.
