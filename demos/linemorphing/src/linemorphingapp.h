...
namespace nap
{
	 ...
	 */
	class LineMorphingApp : public App
	{
		RTTI_ENABLE(App)
	public:
		LineMorphingApp(nap::Core& core) : App(core)	{ }
	...
	private:
		...
		ResourcePtr<ParameterFloat> mLineRotationParam = nullptr;		//< Parameter that controls line rotation
