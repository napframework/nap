...
namespace nap
{
	...
	public:
		...
		*/
		...
		/**
		 * @return the cached connectivity map
		 */
		const utility::MeshConnectivityMap& getConnectivityMap()			{ return mConnectivityMap; }
	...
	private:
		...
		utility::MeshConnectivityMap mConnectivityMap;
