...
RTTI_BEGIN_CLASS(nap::ParticleEmitterComponent, "Emits particles and creates a dynamic mesh that can be rendered")
	...
	RTTI_PROPERTY("PositionVariation",		&nap::ParticleEmitterComponent::mPositionVariation,			nap::rtti::EPropertyMetaData::Default, "Deviation from position")
	RTTI_PROPERTY("LifeTimeVariation",		&nap::ParticleEmitterComponent::mLifeTimeVariation,			nap::rtti::EPropertyMetaData::Default, "Variation on life in seconds")
	RTTI_PROPERTY("Size",					&nap::ParticleEmitterComponent::mSize,						nap::rtti::EPropertyMetaData::Default, "Default size of a particle")
	RTTI_PROPERTY("SizeVariation",			&nap::ParticleEmitterComponent::mSizeVariation,				nap::rtti::EPropertyMetaData::Default, "Allowed deviation from the default size")
	RTTI_PROPERTY("Rotation",				&nap::ParticleEmitterComponent::mRotation,					nap::rtti::EPropertyMetaData::Default, "Start rotation")
	RTTI_PROPERTY("RotationVariation",		&nap::ParticleEmitterComponent::mRotationVariation,			nap::rtti::EPropertyMetaData::Default, "Amount of deviation from initial rotation")
	RTTI_PROPERTY("RotationSpeed",			&nap::ParticleEmitterComponent::mRotationSpeed,				nap::rtti::EPropertyMetaData::Default, "How fast the particle rotates around it's axis")
	RTTI_PROPERTY("RotationSpeedVariation", &nap::ParticleEmitterComponent::mRotationSpeedVariation,	nap::rtti::EPropertyMetaData::Default, "Amount of deviation from particle rotation speed")
	RTTI_PROPERTY("Spread",					&nap::ParticleEmitterComponent::mSpread,					nap::rtti::EPropertyMetaData::Default, "Amount of velocity spread in x / z axis")
	RTTI_PROPERTY("Velocity",				&nap::ParticleEmitterComponent::mVelocity,					nap::rtti::EPropertyMetaData::Default, "Initial velocity")
	RTTI_PROPERTY("VelocityVariation",		&nap::ParticleEmitterComponent::mVelocityVariation,			nap::rtti::EPropertyMetaData::Default, "Deviation from initial velocity")
	RTTI_PROPERTY("StartColor",				&nap::ParticleEmitterComponent::mStartColor,				nap::rtti::EPropertyMetaData::Default, "Particle start of life color")
	RTTI_PROPERTY("EndColor",				&nap::ParticleEmitterComponent::mEndColor,					nap::rtti::EPropertyMetaData::Default, "Particle end of life color")
RTTI_END_CLASS
