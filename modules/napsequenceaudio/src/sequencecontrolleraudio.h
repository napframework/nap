...
namespace nap
{
	...
	public:
		 ...
		 */
		SequenceControllerAudio(SequenceService& service, SequencePlayer & player, SequenceEditor& editor) : SequenceController(service, player, editor) { }
	...
	private:
		 ...
		 */
        audio::AudioBufferResource* findAudioBufferForTrack(const std::string& trackID, const std::string& audioBufferID);
