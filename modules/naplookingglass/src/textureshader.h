...
namespace nap
{
	...
	namespace uniform
	{
		...
		{	
			namespace sampler
			{
				constexpr const char* colorTexture = "colorTexture";		///< Name of the color texture sampler
			}

			constexpr const char* color			= "color";		///< color value (0-1)
			constexpr const char* alpha			= "alpha";		///< alpha value (0-1)
