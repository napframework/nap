...
{
	/**
	 * Base class of all OpenCV video capture devices, including: 
	 * Video files, image sequences, cameras and web-streams.
	 * Override the various virtual functions to implement your OpenCV capture device.
	 */
	...
	protected:
		...
		*/
		 ...
		 */
		virtual bool onOpen(cv::VideoCapture& captureDevice, nap::utility::ErrorState& error) = 0;
