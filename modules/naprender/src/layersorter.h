...
namespace nap
{
	...
	public:
		 ...
		 */
		LayerComparer(EMode mode, const glm::mat4x4& viewMatrix);
	...
	namespace sorter
	{
		 ...
		 */
		void NAPAPI sortObjectsByLayer(std::vector<RenderableComponentInstance*>& comps, const glm::mat4& viewMatrix);
	}
}
