...
RTTI_BEGIN_CLASS(nap::BufferBindingStruct)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingStruct::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS

RTTI_BEGIN_CLASS(nap::BufferBindingUInt)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingUInt::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS

RTTI_BEGIN_CLASS(nap::BufferBindingInt)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingInt::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS

RTTI_BEGIN_CLASS(nap::BufferBindingFloat)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingFloat::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS

RTTI_BEGIN_CLASS(nap::BufferBindingVec2)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingVec2::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS

RTTI_BEGIN_CLASS(nap::BufferBindingVec3)
	RTTI_PROPERTY("Buffer", &nap::BufferBindingVec3::mBuffer, nap::rtti::EPropertyMetaData::Required)
RTTI_END_CLASS
