...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::IntVertexBuffer)
	...
	RTTI_PROPERTY("VertexAttribute", &nap::IntVertexBuffer::mIsVertexAttribute, nap::rtti::EPropertyMetaData::Default)
...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::FloatVertexBuffer)
	...
	RTTI_PROPERTY("VertexAttribute", &nap::FloatVertexBuffer::mIsVertexAttribute, nap::rtti::EPropertyMetaData::Default)
...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::Vec2VertexBuffer)
	...
	RTTI_PROPERTY("VertexAttribute", &nap::Vec2VertexBuffer::mIsVertexAttribute, nap::rtti::EPropertyMetaData::Default)
...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::Vec3VertexBuffer)
	...
	RTTI_PROPERTY("VertexAttribute", &nap::Vec3VertexBuffer::mIsVertexAttribute, nap::rtti::EPropertyMetaData::Default)
...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::Vec4VertexBuffer)
	...
	RTTI_PROPERTY("VertexAttribute", &nap::Vec4VertexBuffer::mIsVertexAttribute, nap::rtti::EPropertyMetaData::Default)
