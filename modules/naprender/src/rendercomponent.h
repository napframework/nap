...
namespace nap
{
	...
	public:
		 ...
		 */
		void draw(VkCommandBuffer commandBuffer, int frameIndex, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix);
	...
	protected:
		 ...
		 * @param projectionMatrix often the camera projection matrix
		 */
		virtual void onDraw(VkCommandBuffer commandBuffer, int frameIndex, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix) = 0;
