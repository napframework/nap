...
namespace nap
{
	...
	public:
		 ...
		 */
		void draw(opengl::RenderTarget& renderTarget, VkCommandBuffer commandBuffer, int frameIndex, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix);
	...
	protected:
		 ...
		 * @param projectionMatrix often the camera projection matrix
		 */
		virtual void onDraw(opengl::RenderTarget& renderTarget, VkCommandBuffer commandBuffer, int frameIndex, const glm::mat4& viewMatrix, const glm::mat4& projectionMatrix) = 0;
