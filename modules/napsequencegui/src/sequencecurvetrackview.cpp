...
namespace nap
{
	...
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegment<SequenceTrackSegmentCurve<float>>(const std::string& trackId, double time);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegment<SequenceTrackSegmentCurve<glm::vec2>>(const std::string& trackId, double time);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegment<SequenceTrackSegmentCurve<glm::vec3>>(const std::string& trackId, double time);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegment<SequenceTrackSegmentCurve<glm::vec4>>(const std::string& trackId, double time);

	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegmentInto<SequenceTrackSegmentCurve<float>>(const std::string& trackId, const std::string& segmentID);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegmentInto<SequenceTrackSegmentCurve<glm::vec2>>(const std::string& trackId, const std::string& segmentID);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegmentInto<SequenceTrackSegmentCurve<glm::vec3>>(const std::string& trackId, const std::string& segmentID);
	template NAPAPI void SequenceCurveTrackView::pasteClipboardSegmentInto<SequenceTrackSegmentCurve<glm::vec4>>(const std::string& trackId, const std::string& segmentID);

	template NAPAPI void SequenceCurveTrackView::drawInspectorRange<float>(const SequenceTrack& track);
	template NAPAPI void SequenceCurveTrackView::drawInspectorRange<glm::vec2>(const SequenceTrack& track);
	template NAPAPI void SequenceCurveTrackView::drawInspectorRange<glm::vec3>(const SequenceTrack& track);
	template NAPAPI void SequenceCurveTrackView::drawInspectorRange<glm::vec4>(const SequenceTrack& track);

	template NAPAPI bool SequenceCurveTrackView::handleCurvePointActionPopup<float>();
	template NAPAPI bool SequenceCurveTrackView::handleCurvePointActionPopup<glm::vec2>();
	template NAPAPI bool SequenceCurveTrackView::handleCurvePointActionPopup<glm::vec3>();
	template NAPAPI bool SequenceCurveTrackView::handleCurvePointActionPopup<glm::vec4>();

	template NAPAPI bool SequenceCurveTrackView::handleSegmentValueActionPopup<float>();
	template NAPAPI bool SequenceCurveTrackView::handleSegmentValueActionPopup<glm::vec2>();
	template NAPAPI bool SequenceCurveTrackView::handleSegmentValueActionPopup<glm::vec3>();
	template NAPAPI bool SequenceCurveTrackView::handleSegmentValueActionPopup<glm::vec4>();

	template NAPAPI void SequenceCurveTrackView::drawTanHandler<float>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		std::ostringstream &stringStream,
		const float segmentWidth,
		...
		const SequenceCurveEnums::TanPointTypes type,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawTanHandler<glm::vec2>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		std::ostringstream &stringStream,
		const float segmentWidth,
		...
		const SequenceCurveEnums::TanPointTypes type,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawTanHandler<glm::vec3>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		std::ostringstream &stringStream,
		const float segmentWidth,
		...
		const SequenceCurveEnums::TanPointTypes type,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawTanHandler<glm::vec4>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		std::ostringstream &stringStream,
		const float segmentWidth,
	...
	template NAPAPI void SequenceCurveTrackView::drawCurves<float>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float previousSegmentX,
		...
		const float segmentX,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawCurves<glm::vec2>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float previousSegmentX,
		...
		const float segmentX,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawCurves<glm::vec3>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float previousSegmentX,
		...
		const float segmentX,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawCurves<glm::vec4>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float previousSegmentX,
	...
	template NAPAPI void SequenceCurveTrackView::drawControlPoints<float>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		const float segmentWidth,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawControlPoints<glm::vec2>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		const float segmentWidth,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawControlPoints<glm::vec3>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		const float segmentWidth,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawControlPoints<glm::vec4>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
	...
	template NAPAPI void SequenceCurveTrackView::drawSegmentValue<float>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		...
		const SequenceCurveEnums::SegmentValueTypes segmentType,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawSegmentValue<glm::vec2>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		...
		const SequenceCurveEnums::SegmentValueTypes segmentType,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawSegmentValue<glm::vec3>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
		...
		const SequenceCurveEnums::SegmentValueTypes segmentType,
		ImDrawList* drawList);
	template NAPAPI void SequenceCurveTrackView::drawSegmentValue<glm::vec4>(
		const SequenceTrack& track,
		const SequenceTrackSegment& segment,
		const ImVec2 &trackTopLeft,
		const float segmentX,
	...
	template NAPAPI void SequenceCurveTrackView::drawSegmentContent<float>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		const ImVec2& trackTopLeft,
		float previousSegmentX,
		...
		ImDrawList* drawList,
		bool drawStartValue);
	template NAPAPI void SequenceCurveTrackView::drawSegmentContent<glm::vec2>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		const ImVec2& trackTopLeft,
		float previousSegmentX,
		...
		ImDrawList* drawList,
		bool drawStartValue);
	template NAPAPI void SequenceCurveTrackView::drawSegmentContent<glm::vec3>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		const ImVec2& trackTopLeft,
		float previousSegmentX,
		...
		ImDrawList* drawList,
		bool drawStartValue);
	template NAPAPI void SequenceCurveTrackView::drawSegmentContent<glm::vec4>(
		const SequenceTrack &track,
		const SequenceTrackSegment &segment,
		const ImVec2& trackTopLeft,
		float previousSegmentX,
