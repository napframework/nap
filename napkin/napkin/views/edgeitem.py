...
from napkin.views.inoutnodeitem import InputSocketItem
from napkin.views.inoutnodeitem import OutputSocketItem
from napkin.views.nodeitem import SocketItem
from napkin.views.patchutils import calculateWirePath
