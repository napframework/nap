...
from coresettings.coresettingswidget import CoreSettingsWidget
...
_DEFAULT_SETTINGS = 'napkin_defaults.ini'
...
class MainWindow(QMainWindow):
    ...
    def __getOrCreateEditor(self, obj: nap.Object):
    ...
    def __onSelectionChanged(self, obj: nap.Object):
    ...
    def __setupUi(self):
        ...
        self.connector = CoreSettingsWidget(self.ctx)
    ...
    def __restoreDefault(self):
        self.__restore(QSettings(_DEFAULT_SETTINGS, QSettings.IniFormat))
        self.center()

    def __restore(self, s=None):
        if not s:
            s = QSettings()
    ...
    def addDock(self, w: QWidget, area, name):
    ...
    def destroyDock(self, dock: QDockWidget):
        # just in case we're dealing with an editor
