	...
	*/
	...
	public:
		...
		*/
		...
		ObjectPtr<ImageFromFile>	mDebugImage;										///< Property: Debug image used to display the currently selected palette
	...
	private:
		...
		ObjectPtr<ImageFromFile>	mDebugImage;								///< Debug image used to display the currently selected palette
