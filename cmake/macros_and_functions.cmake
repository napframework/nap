...
# Find SDL2
macro(find_sdl)
    # Because we use the upstream SDL3 config, we augment it with some extra platform specifc vars
    set(SDL_DIR ${NAP_ROOT}/system_modules/naprender/thirdparty/sdl)
    set(SDL_LICENSE_FILES ${SDL_DIR}/LICENSE.txt)
    if(NOT TARGET SDL3)
        if(WIN32)
            set(SDL_LIBS_DIR ${SDL_DIR}/msvc/x86_64/lib)
            set(SDL_BIN_DIR ${SDL_DIR}/msvc/x86_64/bin)
            set(CMAKE_LIBRARY_PATH ${SDL_LIBS_DIR})
            set(CMAKE_PREFIX_PATH ${SDL_DIR}/msvc/x86_64/cmake)
        elseif(UNIX)
            set(SDL_LIBS_DIR ${SDL_DIR}/linux/${ARCH}/lib)
            set(CMAKE_LIBRARY_PATH ${SDL_LIBS_DIR})
            set(CMAKE_PREFIX_PATH ${SDL_DIR}/linux/${ARCH}/lib/cmake)
        endif()
        find_package(SDL3 REQUIRED CONFIG REQUIRED COMPONENTS SDL3-shared)
        get_target_property(SDL_INCLUDE_DIR SDL3::Headers INTERFACE_INCLUDE_DIRECTORIES)
        set(SDL_INCLUDE_DIR ${SDL_INCLUDE_DIR}/SDL3)
    endif()
endmacro()
