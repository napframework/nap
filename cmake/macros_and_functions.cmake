...
function(configure_python)
    ...
    elseif(CMAKE_HOST_APPLE)
        set(PYTHON_BIN ${PYTHON_PREFIX}/macos/universal/bin/python3)
        set(PYTHON_LIB_DIR ${PYTHON_PREFIX}/macos/universal/lib PARENT_SCOPE)
    else()
...
macro(find_sdl2)
    ...
    if(NOT TARGET SDL2)
        ...
        elseif(APPLE)
            set(SDL2_LIBS_DIR ${SDL2_DIR}/macos/${ARCH}/lib)
            set(CMAKE_LIBRARY_PATH ${SDL2_LIBS_DIR})
            set(CMAKE_PREFIX_PATH ${SDL2_DIR}/macos/${ARCH})
        elseif(UNIX)
