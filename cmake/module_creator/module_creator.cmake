...
if(DEFINED APP_MODULE)
    ...
    if(NOT DEFINED MODULE_DIR)
        set(MODULE_DIR ${NAP_ROOT}/modules/nap${UNPREFIXED_MODULE_NAME_INPUTCASE})
    endif()
    set(PATH_FROM_MODULE_TO_NAP_ROOT ../..)
endif()
...
if(NOT DEFINED APP_MODULE)
    ...
    if(UNIX)
        ...
        configure_file(${src_dir}/prepare_to_share.sh ${MODULE_DIR}/prepare_to_share.sh @ONLY)
    elseif(WIN32)
        set(src_dir ${src_dir}/win64)
        configure_file(${src_dir}/regenerate.bat ${MODULE_DIR}/regenerate.bat @ONLY)
        configure_file(${src_dir}/prepare_to_share.bat ${MODULE_DIR}/prepare_to_share.bat @ONLY)
    endif()
endif()
