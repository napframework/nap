...
elseif(APPLE)
    ...
    set(FREEIMAGE_INCLUDE_DIRS ${FREEIMAGE_DIR}/include/)
    set(FREEIMAGE_LIBS_DLL ${FREEIMAGE_DIR}/lib/libfreeimage-3.18.0.dylib)
elseif(UNIX)
    find_path(
        FREEIMAGE_DIR
...
FIND_PACKAGE_HANDLE_STANDARD_ARGS(FreeImage REQUIRED_VARS FREEIMAGE_DIR FREEIMAGE_LIBS_DLL FREEIMAGE_INCLUDE_DIRS)
