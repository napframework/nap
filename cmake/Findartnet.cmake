...
if(WIN32)
    ...
    set(ARTNET_INCLUDE_DIRS ${ARTNET_DIR}/source)
...
elseif(APPLE)
    ...
    set(ARTNET_INCLUDE_DIRS ${ARTNET_DIR} ${ARTNET_DIR}/macos/x86_64)
...
elseif(ANDROID)
    ...
    set(ARTNET_LIBS ${ARTNET_LIBS_DIR}/libartnet.so)
    set(ARTNET_INCLUDE_DIRS ${ARTNET_DIR} ${ARTNET_LINUX_DIR}/include)
    set(ARTNET_LIBS_RELEASE_DLL ${ARTNET_LIBS})
endif()
