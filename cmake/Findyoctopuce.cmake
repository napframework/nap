...
elseif(APPLE)
    ...
    set(YOCTO_LIBS_DEBUG ${YOCTO_DIR}/Binaries/linux/64bits/yapi/libyapi.so.1.0.1)
    set(YOCTO_LIBS_RELEASE ${YOCTO_DIR}/Binaries/linux/64bits/yapi/libyapi.so.1.0.1)
    set(YOCTO_LIBS_DIR ${YOCTO_DIR}/Binaries/linux/64bits/yapi)
endif()
