...
latex_documents = [
    (master_doc, 'pynap.tex', u'pynap Documentation',
...
man_pages = [
    (master_doc, 'pynap', u'pynap Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pynap', u'pynap Documentation',
     author, 'pynap', 'One line description of project.',
     'Miscellaneous'),
]
