...
if(UNIX)
    ...
    configure_file(${NAP_ROOT}/tools/platform/project_dir_shortcuts/build_cli ${PROJECT_DIR}/build @ONLY)
elseif(WIN32)
    ...
    configure_file(${NAP_ROOT}/tools/platform/project_dir_shortcuts/build_cli.bat ${PROJECT_DIR}/build.bat @ONLY)    
endif()
