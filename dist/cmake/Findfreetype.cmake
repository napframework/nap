...
elseif(APPLE)
    set(FREETYPE_LIBS_DEBUG ${FREETYPE_DIR}/bin/libfreetype.dylib)
    set(FREETYPE_LIBS_RELEASE ${FREETYPE_DIR}/bin/libfreetype.dylib)
    set(FREETYPE_LIBS_DIR ${FREETYPE_DIR}/bin)
    set(FREETYPE_DEBUG_DLL ${FREETYPE_LIBS_DEBUG})
    set(FREETYPE_RELEASE_DLL ${FREETYPE_LIBS_RELEASE})
elseif(UNIX)
    set(FREETYPE_LIBS_DEBUG ${FREETYPE_DIR}/bin/libfreetype.so)
    set(FREETYPE_LIBS_RELEASE ${FREETYPE_DIR}/bin/libfreetype.so)
    set(FREETYPE_LIBS_DIR ${FREETYPE_DIR}/bin)
    set(FREETYPE_DEBUG_DLL ${FREETYPE_LIBS_DEBUG})
    set(FREETYPE_RELEASE_DLL ${FREETYPE_LIBS_RELEASE})
endif()
