...
RTTI_BEGIN_CLASS_NO_DEFAULT_CONSTRUCTOR(nap::LucyMesh, "Female figurine 3D mesh, located at the origin with a height of 1.")
	RTTI_CONSTRUCTOR(nap::Core&)
	RTTI_PROPERTY("Usage",			&nap::LucyMesh::mUsage,			nap::rtti::EPropertyMetaData::Default,	"If the mesh is static or frequently updated")
	RTTI_PROPERTY("CullMode",		&nap::LucyMesh::mCullMode,		nap::rtti::EPropertyMetaData::Default,	"Controls which triangles are culled, back facing, front facing etc.")
	RTTI_PROPERTY("PolygonMode",	&nap::LucyMesh::mPolygonMode,	nap::rtti::EPropertyMetaData::Default,	"Mesh polygon draw mode (fill, wires, points)")
RTTI_END_CLASS
...
namespace nap
{
	LucyMesh::LucyMesh(Core& core) :
		mRenderService(core.getService<RenderService>())
	{ }


	bool LucyMesh::init(utility::ErrorState& errorState)
	{
		// Find asset
		assert(mRenderService != nullptr);
		static constexpr const char* humanoid_asset = "meshes/lucy.fbx";
