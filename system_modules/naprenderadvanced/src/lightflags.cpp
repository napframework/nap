...
namespace nap
{
	...
	{
		bool shadow_enabled = light.isShadowSupported() ? light.isShadowEnabled() : false;
		...
		flags |= (static_cast<uint>(light.isShadowSupported()) & SHADOW_SUPPORTED_BITS)		<< SHADOW_SUPPORTED_SHIFT;
