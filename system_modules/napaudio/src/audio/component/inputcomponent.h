...
namespace nap
{
	namespace audio
	{
		...
		public:
			...
			bool mAllowOutOfBoundChannels = true; ///< property: 'AllowOutOfBoundChannels Indicates if input channels that are out of bounds will producere zero input or generate an init error.'
